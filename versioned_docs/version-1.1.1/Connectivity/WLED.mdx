...
:::note
The **Instrument Visualizations** section is not yet enabled. The **LiteJam** LED guitar is rolling out to testers; see **[LiteJam LED Guitar](/Connectivity/LiteJamGuitar)**.
:::
