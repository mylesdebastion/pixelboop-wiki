...
export function SyncOverview() {
    const uiElements = [
        ...
        {
            "name": "Link Button",
            "desc": "Columns 5-7, Row 23. Ableton Link (not available as of v1.1.2 — cols 5-7 are dark).",
            "elements": [
...
:::note
**Ableton Link** (timing sync) is not available as of Pixelboop v1.1.2 and will be enabled in a future update. WiFi Sync handles both state and timing synchronization between devices.
:::
...
:::note
**Ableton Link** is not available as of Pixelboop v1.1.2. It will be enabled in a future update.
:::
