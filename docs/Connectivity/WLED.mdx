...
:::note
**Instrument Visualizations** (each instrument driving its own WLED lights) and the **LiteJam** LED guitar are part of [Pixelboop Pro](/GettingStarted/PixelboopPro); see **[LiteJam LED Guitar](/Connectivity/LiteJamGuitar)**.
:::
