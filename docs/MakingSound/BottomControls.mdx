...
export function BottomRowOverview() {
    const uiElements = [
        ...
        {
            "name": "Link Button",
            "desc": "Columns 5-7. Ableton Link (not available as of v1.1.2 — cols 5-7 are dark).",
            "elements": [
...
:::note
**Ableton Link** is not available as of Pixelboop v1.1.2. Columns 5–7 in row 23 are dark/empty. Ableton Link will be enabled in a future update.
:::
...
| **Link** | 5-7 | Ableton Link (unavailable as of v1.1.2) | — | — |
