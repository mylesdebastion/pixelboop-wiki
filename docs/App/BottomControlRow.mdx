...
**See [Multi-Device Sync](MultiDeviceSync.mdx) for collaboration setup.**
...
**See [Multi-Device Sync](MultiDeviceSync.mdx) for full collaboration guide.**
...
- [Multi-Device Sync](MultiDeviceSync.mdx) - Collaboration setup
