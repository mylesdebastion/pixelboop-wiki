...
**See Also:**
- [Control Row](ControlRow.mdx) - Row 0 controls
- [Gestures](Gestures.mdx) - Touch gestures
- [Song Sections](SongSections.mdx) - Section management
